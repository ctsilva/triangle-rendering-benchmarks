...
#define wglFreeMemoryNV glXFreeMemoryNV
#endif

static float MinPeriod = 2.0;   /* 2 seconds */
static float Width = 800.0;
...
static const int MY_DISPLAY_LIST = 1;
static unsigned num_triangles = 0;
